   ...
   /*
    public class Rope {
        ...
        public static void main(String[] args) {
           ...
           //Rope rope = new Rope();
           //rope.play();
           //  Rope rope2 = null; // deger atamış gibi gosterip deger atamamış rope2.playi calıstırmak icin.
           // rope2.play(); // play() methodu static oldugundan, objeye ihtiyac yok, Java rope2'yi yok sayiyor
