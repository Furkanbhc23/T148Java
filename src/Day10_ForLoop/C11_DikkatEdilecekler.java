...
public class C11_DikkatEdilecekler {
    public static void main(String[] args) {
        ...
        // Onemli not: Eger kullanıcıdan aldıgımız sayıyı birden fazla degerlendirmemiz gerekiyorsa
        // direkt bunu kullanmak yerine gecici bir variable olusturup int degerini girilen sayıya atayıp onun üzerinde
        // islem yaparız.
