...
public class C08_AynıIndextekileriToplama {
...
//     output:                       [5, 7, 11]
        ...
        int [] istenenArray = new int[ortakIndexSayisi]; // [0, 0, 0] // istenen new int ortakindexsayısı kadar demektir.
        // ortak index sayısı 3 tane ise ortak indexsayısı da 3 eleman olacak.
