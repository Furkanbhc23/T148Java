...
public class C02_ListMethodları {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar.size()); // 9 // length=size.
        ...
        System.out.println(sayilar.lastIndexOf(2)); // 5 // 5.indexte demek.
        ...
        if (sayilar.indexOf(2) == -1){ // listede 2 yok demektir bu ifade
            System.out.println("listede 2 yok");
        } else if ( sayilar.indexOf(2) == sayilar.lastIndexOf(2)) { // hem en bastan hem en sondan aynı 2 yi işaret eder.
            // yani 1 tane var demektir.
