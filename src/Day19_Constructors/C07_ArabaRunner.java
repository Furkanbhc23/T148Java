...
public class C07_ArabaRunner {
    public static void main(String[] args) {
        ...
        C06_Araba araba1 = new C06_Araba(); // objesi var calısır sadece buraya kadar yazsak bile.

        System.out.println(araba1.marka); // Toyota // classa gitmez (C06daki classa) direk kendi atadıgı objeye gore yapar.
        ...
        System.out.println(araba1); // classta ilk belirlenen neyse onu yazar.
