...
public class C13_Cars {
    ...
    C13_Cars(String mrk, String mdl) {
    ...
    C13_Cars(String marka, String model, int yil) {
    ...
    public C13_Cars(String marka, String model, String renk, int yil, int fiyat) {
        this.marka = marka;
        this.model = model;
        this.renk = renk;
        this.yil = yil;
