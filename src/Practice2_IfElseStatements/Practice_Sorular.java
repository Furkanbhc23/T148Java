...
public class Practice_Sorular {
   ...
   */
        ...
        int ikinciKullanim=metin.indexOf(harf,ilkKullanim+1); // + 1 demesinin sebebi ikinci kullanımı ogrenmek
        if (ilkKullanim!=-1 && ikinciKullanim==-1){
            ...
            // ey edip adanada pide ye yazdık boyle yazdı //Hangi harfi arıyorsunuz: a //Aradığınız harfin ilk index no: 8
            // aradığınız harfin ikinci index no: 10
           // ey edip adanada pide ye yazdık // Hangi harfi arıyorsunuz: n //Aradığınız harfin ilk index no: 11
            //Aradığınız harf sadece 1 tane vardır
        }
    }
}
