...
public class C08_AvciKuslar extends C07_Kuslar {
    public void hareket() { // methoddaki hareketi değiştiriyor demek.
        System.out.println("ucarlar");
    }

    public void beslenme() { // yukarıdaki beslenmeyi değiştiriyor demek.
    ...
    public void gaga() { // yanında ok olmasının sebebi yukarıdaki methodu değiştiriyor demek.
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            DAHA GUNCEL BILGI var mi diye kontrol ederiz. Güncel demek en son ki deger ne atanamışsa.
        ...
        C06_Hayvanlar kusHayvani = new C07_Kuslar(); // Güncel arama Constructor kısmına kadardır. YANİ C07_Kuslar();
        ...
        C07_Kuslar kus1 = new C07_Kuslar(); // Güncel arama Constructor kısmına kadardır. YANİ C07_Kuslar();
        ...
        C06_Hayvanlar hayvanKartal = new C08_AvciKuslar(); // Güncel arama Constructor kısmına kadardır. YANİ C08_Kuslar();
