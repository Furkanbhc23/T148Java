...
public class C05_AvciKuslar extends C04_Kuslar {
    ...
    public static void main(String[] args) {
        ...
        String str = "Java candir"; // Buradaki String variable oldugu gibi (strnin) aynı zamanda javada bir "class"tır.
        ArrayList<String> isimler = new ArrayList<>(); // Buradaki ArrayList de bir "class"tır. Bu classtan oluşturulan şeyler icinde
        // data türüdür.
        ...
        /*
           ...
           ONEMLİ:: EGER ozellikler variable olarak olusturulmussa
            DATA TURU belirleyicidir
         */

        // Kuslar class'indan bir obje olusturun

        C03_Hayvanlar  hayvan1 = new C03_Hayvanlar(); // new C03_Hayvanlar(); Constructordır.
        // C03_Hayvanlar hayvan1 isimli obje icin data türü, aynı zamanda bir classtır.
        // Bir objenin hangi classın objesi oldugunu constructor belirler.
        // Data türü de aramaya başlayacağımız yeri belirler yani burada "C03_Hayvanlar" oluyor.
        // Hangi classtan başlıyor onu belirliyoruz ==> new "C03_Hayvanlar()" ,  daha sonra aramaya nerden başlıyor onu belirliyoruz. "C03_Hayvanlar"
        System.out.println(hayvan1.omur); // H yasar ve olur // buradaki omur variabledır.
        ...
        // C03_Hayvanlar kusHayvani isimli obje icin data türü, aynı zamanda bir classtır.
        ...
        C04_Kuslar kusKartal = new C05_AvciKuslar(); // obje C05tedir ama aramaya C04ten başlanır.
