...
public abstract class C03_KuralciParent {
    ...
    public abstract void method1(); // anlamı şu: Child classların method 1 i kendine uyarlamak zorunda.
    // Normal methodlardan farklı olarak parantezin yanına noktalı virgül koyduk.
