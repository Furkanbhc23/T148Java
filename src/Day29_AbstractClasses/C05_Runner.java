...
import Day23_Date_Time_varargs.C05_Varargs;
...
public class C05_Runner {
    public static void main(String[] args) {
        ...
        C01_KuralcıOlmayanParent kop1 = new C01_KuralcıOlmayanParent(); // Abstract methodlardan obje oluşturursak onları kullanamayız
        // Cunku onları kural olsun diye koyduk.
        kop1.method1();
