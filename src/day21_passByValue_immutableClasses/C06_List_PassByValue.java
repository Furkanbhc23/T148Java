...
public class C06_List_PassByValue {
    ...
    public static void birIsimEkle(List<String> isimler){
        ...
        isimler.add(scanner.nextLine()); // Kullanıcıdan ismi alıp direk isimler listesine ekleyecek.
    ...
    public static void yeniListeOlustur(List<String> isimler){
        ...
        isimler = new ArrayList<>(); // verilen isimler listesine yeni bos bir liste atayan ifadesi yerine yazdık.
