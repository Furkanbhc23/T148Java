...
public class C03_NestedMap {
    public static void main(String[] args) {
         ...
         */
            ...
            Map<String,String> ogrenci104ValueMap=new HashMap<>();
            ogrenci104ValueMap.put("isim", "Mehmet");
            ogrenci104ValueMap.put("soyisim", "Bahceci");
            ogrenci104ValueMap.put("sınıf", "10");
            ogrenci104ValueMap.put("sube", "C");
            ogrenci104ValueMap.put("bolum", "Say");
            System.out.println(ogrenciMap.put(104, ogrenci104ValueMap));
         ...
         */
            ...
            ogrenciMap.get(103).put("sube","L"); // L

            System.out.println(ogrenciMap.get(104).get("isim")); // Mehmet
